...
public:
	...
	{
	public:
		// determines of the I/O component is connected
	...
	// Request that the I/O component be connected. Must be balanced by a requestDisconnect.
	...
	// Request that the I/O component be disconnected. Must balance a corresponding requestConnect.
	...
	// Notifies the I/O component that an error was detected from outside, e.g. when reading or writing an I/O point.
	...
	// Checks whether the I/O component is up
...
private:
	...
	// Attempts to establish a connection to the I/O component and updates the state accordingly. This function will notify error sinks if anything changes.
	auto connect(std::chrono::system_clock::time_point timeStamp) -> void;

	// Terminates the connection to the I/O component and updates the state accordingly. This function will notify error sinks if anything changes.
